"""Risk analytics — 10 metrics over a (weights, returns) pair.

Pure-function service. The caller fetches return data via DataService and
hands a DataFrame to compute_all(). No I/O inside this module.
"""
...
class RiskService:
    """Stateless. Methods take aligned weights+returns and return floats."""
    ...
    def var_parametric(
        ...
        return mu + z * sigma  # z is negative for left tail
